...
const JobPostForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("http://localhost:3001/api/submit-job-posting", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div id="job-post-form" className="min-h-screen flex items-center justify-center py-12 bg-gray-100">
      <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-4xl">
        <div className="text-center mb-6">
          <h2 className="uppercase text-3xl text-harPrimary">Job Post Creation</h2>
          <p className="mt-4 text-lg text-gray-600 font-thin">
            Fill out the form below to create a job post.
          </p>
        </div>
